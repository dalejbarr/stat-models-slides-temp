...
* [Interactions:]{style="color:black;"} The effect of a predictor variable on the response variable may depend upon the value(s) of one or more other predictor variables.*
...
::: {.aside}
[ANCOVA = Analysis of Covariance; ANOVA = Analysis of Variance]{style="color:black;"}
:::
