...
## Multivariate Analysis / Structural Equation Modeling
...
4. analyze the model (iterative step)
   - estimate quality of the fit
   - if fit is poor, respecify if justified by theory; if not, retain no model
