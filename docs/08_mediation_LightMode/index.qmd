...
| 10      | practical skills assessment 2             |
...
contrast with **moderation** (interaction)
...
- mechanism behind causal relationship
- contrast mediation with moderation (interaction)
...
- topic of 'remote working' is on everyone's minds
...
- TODO: go through and count the degrees of freedom
- remember that in a multiple regression, each regression coefficient tells you the association of the predictor variable with the dependent variable, controlling for all the other variables in the model
...
- open up textbook page and go through
- mention "Sobel test"
