...
[mean ($\mu$, $\bar{X}$):]{style="color:black;"} $\bar{X} = \frac{\Sigma X}{N}$
...
[deviation score:]{style="color:black;"} $X - \bar{X}$
...
[standard deviation ($\sigma$, $S$):[^1]]{style="color:black;"}
...
[variance (${\sigma}^2$, ${S}^2$):]{style="color:black;"}
...
[Relationship between variance and SD]{style="color:black;"}
...
* [scatterplot:]{style="color:black;"} a two-dimensional figure (x and y) representing the relationship in bivariate data (i.e. the relationship between two variables)
...
[covariance ($cov_{XY}$):]{style="color:black;"}
...
[correlation ($\rho_{XY}$, $r_{XY}$)]{style="color:black;"}
...
[Relationship between covariance, correlation and SD]{style="color:black;"}
...
* [$\beta_0$ (y-intercept)]{style="color:black;"}: value of $Y$ where the line cuts through the vertical axis ($X=0$)
* [$\beta_1$ (slope)]{style="color:black;"}: effect of 1 unit increase of $X$ on the value of $Y$
